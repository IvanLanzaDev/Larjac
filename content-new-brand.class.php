            ...
            <form method="post" enctype="multipart/form-data" class="col-12 mt-3">
                <div class="row">
                    <div class="form-group col-12 col-md-4">
                        ...
                        <input type="text" class="form-control" autofocus required name="name_fab">
                    </div>
                    
                </div>
                <div class="row">
                    <div class="col-12 col-md-4 mb-5">
                        <input type="submit" class="btn btn-success d-none d-md-block" name="btn_new_brand" value="Cadastrar Representada">
                        <input type="submit" class="btn btn-success d-block d-md-none btn-block btn-lg" name="btn_new_brand" value="Cadastrar Representada">
                    </div>
                </div>
