    ...
    <div class="row">
        ...
        <div class="col-12 col-md-10 border-left bg-light">
            ...
            <table class="table table-hover table-light border border-primary mt-4">
                      ...
                      <tbody>
                        <?php
                            while($list_messages = mysqli_fetch_array($get_message)){
                                echo "
                                    <tr>
                                      <td>$list_messages[name_msg]</td>
                                      <td></td>
                                      <td><a href='read-message.php?id_message=$list_messages[id_msg]' class='btn btn-primary btn-sm'>Ver Mensagem</a></td>
                                    </tr>
                                ";
                            }  
                        ?>
