    ...
    <div class="row">
        ...
        <div class="col-12 col-md-10 border-left bg-light">
            ...
            <div class="row mx-0 mx-md-2 mt-3 border-bottom border-primary pb-3">
                ...
                <a href="view-categories.php" class="btn btn-danger ml-3">Cancelar</a>
            </div>
            ...
            <form method="post" enctype="multipart/form-data" class="col-12 mt-3">
                ...
                <div class="row">
                    <div class="form-group col-12 col-md-4">
                        ...
                        <input type="text" class="form-control" autofocus required name="name_category" value="<?php echo $list_edit_category[name_category]; ?>">
                    </div>
                    
                </div>
                <div class="row">
                    <div class="col-12 col-md-4 mb-5">
                        <input type="submit" class="btn btn-success d-none d-md-block" name="btn_edit_category" value="Alterar Categoria">
                        <input type="submit" class="btn btn-success d-block d-md-none btn-block btn-lg" name="btn_edit_category" value="Alterar Categoria">
                    </div>
                </div>
