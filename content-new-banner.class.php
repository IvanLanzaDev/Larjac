            ...
            <form method="post" enctype="multipart/form-data" action="#">
                ...
                <div class="row">
                    <div class="input-group mb-3 mt-1 ml-0 ml-md-2 col-12 col-md-6">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" name="img_slider">
                ...
                <div class="row">
                    <div class="form-group col-4 ml-md-2">
                        <label>Link</label>
                        <input type="text" class="form-control" name="link_slider">
                    </div>
                </div>
                    
                    <input type="submit" class="btn btn-success btn-lg btn-block d-block d-md-none" value="Cadastrar Banner" name="btn_new_slider">
                    <input type="submit" class="btn btn-success ml-2 d-none d-md-block mb-3" value="Cadastrar Banner" name="btn_new_slider">
